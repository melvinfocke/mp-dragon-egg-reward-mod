...
public class BigChestScreen extends HandledScreen<ScreenHandler> {
    // A path to the gui texture. In this example the texture from the dispenser
    private static final Identifier TEXTURE = new Identifier("minecraft", "textures/gui/container/generic_54.png");

    public BigChestScreen(ScreenHandler handler, PlayerInventory inventory, Text title) {
